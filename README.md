...
[//]: # (
![bvpttsuite2.0_flowchart.png](https://github.com/MerFa/testest/blob/main/bttsuiteImgs/bvpsuite2.0_flowchart.png)


and of the pathfollowing case:

[//]: # (
![bvpttsuite2.0_pathfollowing_flowchart.png](https://github.com/MerFa/testest/blob/main/bttsuiteImgs/bvpsuite2.0_pathfollowing_flowchart.png)
